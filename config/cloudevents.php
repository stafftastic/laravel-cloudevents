...
return [
    ...
    'kafka' => [
       ...
       */
        'brokers' => env('LARAVEL_CLOUDEVENTS_KAFKA_BROKERS', 'localhost:9092'),
         ...
         */
        'consumer_group_id' => env('LARAVEL_CLOUDEVENTS_KAFKA_CONSUMER_GROUP_ID', 'group'),
         ...
         */
        'offset_reset' => env('LARAVEL_CLOUDEVENTS_KAFKA_OFFSET_RESET', 'latest'),
         ...
         */
        'auto_commit' => env('LARAVEL_CLOUDEVENTS_KAFKA_AUTO_COMMIT', true),

        'sleep_on_error' => env('LARAVEL_CLOUDEVENTS_KAFKA_ERROR_SLEEP', 5),

        'partition' => env('LARAVEL_CLOUDEVENTS_KAFKA_PARTITION', 0),

        /*
         | Kafka supports 4 compression codecs: none , gzip , lz4 and snappy
         */
        'compression' => env('LARAVEL_CLOUDEVENTS_KAFKA_COMPRESSION_TYPE', 'snappy'),
